...
public fun Response.Failure.HttpFailure.isUnauthorized(): Boolean = this.httpCode == 401

public suspend inline fun <T : Any, R: Any> Response<T>.map(crossinline block: suspend (T) -> R): Response<R> = when (this) {
