 ...
 */
public class DatastoreShoppingCartRepository(
    ...
    public object ShoppingCartsDtoSerializer : Serializer<ShoppingCartsDto> {
        ...
        override suspend fun writeTo(t: ShoppingCartsDto, output: OutputStream): Unit = t.writeTo(output)
    }
}
