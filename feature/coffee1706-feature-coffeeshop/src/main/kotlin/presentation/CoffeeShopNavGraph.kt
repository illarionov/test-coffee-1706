...
@StringRes
public fun NavDestination.getCoffeeShopGraphTile(): Int? = when {
    this.hasRoute<CoffeeShopMenuDestination>() -> R.string.screen_title_coffee_shop_menu
    this.hasRoute<CoffeeShopOrderDestination>() -> R.string.screen_title_coffee_shop_order
    else -> null
}

public fun NavGraphBuilder.coffeeShopNavGraph(
