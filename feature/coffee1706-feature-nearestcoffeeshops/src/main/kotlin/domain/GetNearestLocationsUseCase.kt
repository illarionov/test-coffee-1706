...
internal interface GetNearestLocationsUseCase {
    suspend fun getNearestLocations(location: LatLon): Response<List<NearestLocation>>
}

internal class GetNearestLocationsUseCaseImpl @Inject constructor(
